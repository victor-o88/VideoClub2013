...
public class Alquileres {
    ...
    public Alquileres(Integer id_alquiler, /*GestorClientes cliente,*/ Date fecha_alquiler, Integer monto_alquiler, Date fecha_entrega, Integer estado, Integer id_cliente) {
        this.id_alquiler = id_alquiler;
        //this.cliente = cliente;
        this.fecha_alquiler = fecha_alquiler;
        this.monto_alquiler = monto_alquiler;
